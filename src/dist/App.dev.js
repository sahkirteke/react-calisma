...
var app = function app(props) {
  var _useState = (0, _react.useState)({
    ...
    otherState: "bazı değerler içün"
      ...
      personsState = _useState2[0],
      setPersonsState = _useState2[1];

  var _useState3 = (0, _react.useState)('bazı değişmeler'),
      _useState4 = _slicedToArray(_useState3, 2),
      otherState = _useState4[0],
      setOtherState = _useState4[1];

  var switchNameHandler = function switchNameHandler() {
